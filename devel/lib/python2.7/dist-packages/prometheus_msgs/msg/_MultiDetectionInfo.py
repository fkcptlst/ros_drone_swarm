...
class MultiDetectionInfo(genpy.Message):
  _md5sum = "405c23f2d6cf2075daf7e96c3ccd5179"
...
"""
  __slots__ = ['header','num_objs','detect_or_track','detection_infos']
  _slot_types = ['std_msgs/Header','int32','int32','prometheus_msgs/DetectionInfo[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,num_objs,detect_or_track,detection_infos
    ...
    if args or kwds:
      ...
      if self.num_objs is None:
        self.num_objs = 0
      if self.detect_or_track is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2i().pack(_x.num_objs, _x.detect_or_track))
      ...
      for val1 in self.detection_infos:
        ...
        buff.write(_get_struct_2i().pack(*val1.pixel_position))
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.num_objs, _x.detect_or_track,) = _get_struct_2i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.detection_infos = []
      for i in range(0, length):
        ...
        val1.pixel_position = _get_struct_2i().unpack(str[start:end])
        _x = val1
        start = end
        end += 8
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.detection_infos:
        ...
        buff.write(val1.pixel_position.tostring())
        _x = val1
        buff.write(_get_struct_fi().pack(_x.yaw_error, _x.category))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.pixel_position = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=2)
        _x = val1
        start = end
        end += 8
        (_x.yaw_error, _x.category,) = _get_struct_fi().unpack(str[start:end])
