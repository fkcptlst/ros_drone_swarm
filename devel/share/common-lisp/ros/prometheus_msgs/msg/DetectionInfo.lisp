...
(cl:defclass <DetectionInfo> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (pixel_position
    :reader pixel_position
    :initarg :pixel_position
...
(cl:ensure-generic-function 'pixel_position-val :lambda-list '(m))
(cl:defmethod pixel_position-val ((m <DetectionInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:pixel_position-val is deprecated.  Use prometheus_msgs-msg:pixel_position instead.")
  (pixel_position m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DetectionInfo>) ostream)
  ...
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let* ((signed ele) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
   ...
   (cl:slot-value msg 'pixel_position))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DetectionInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'sight_angle)))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:aref vals i) (roslisp-utils:decode-single-float-bits bits)))))
  (cl:setf (cl:slot-value msg 'pixel_position) (cl:make-array 2))
  (cl:let ((vals (cl:slot-value msg 'pixel_position)))
    (cl:dotimes (i 2)
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DetectionInfo>)))
  ...
  "64a1138d8e77ba66759026fce69b90a9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DetectionInfo)))
  "Returns md5sum for a message object of type 'DetectionInfo"
  "64a1138d8e77ba66759026fce69b90a9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DetectionInfo>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%## 目标类别名称~%string object_name~%~%## 是否检测到目标~%bool detected~%~%## 0表示相机坐标系, 1表示机体坐标系, 2表示惯性坐标系~%int32 frame~%~%## 目标位置[相机系下：右方x为正，下方y为正，前方z为正]~%float32[3] position~%~%## 目标姿态-欧拉角-(z,y,x)~%float32[3] attitude~%~%## 目标姿态-四元数-(qx,qy,qz,qw)~%float32[4] attitude_q~%~%## 视线角度[相机系下：右方x角度为正，下方y角度为正]~%float32[2] sight_angle~%~%## 像素位置[相机系下：右方x为正，下方y为正]~%int32[2] pixel_position~%~%## 偏航角误差~%float32 yaw_error~%~%## 类别~%int32 category~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DetectionInfo)))
  "Returns full string definition for message of type 'DetectionInfo"
  (cl:format cl:nil "std_msgs/Header header~%~%## 目标类别名称~%string object_name~%~%## 是否检测到目标~%bool detected~%~%## 0表示相机坐标系, 1表示机体坐标系, 2表示惯性坐标系~%int32 frame~%~%## 目标位置[相机系下：右方x为正，下方y为正，前方z为正]~%float32[3] position~%~%## 目标姿态-欧拉角-(z,y,x)~%float32[3] attitude~%~%## 目标姿态-四元数-(qx,qy,qz,qw)~%float32[4] attitude_q~%~%## 视线角度[相机系下：右方x角度为正，下方y角度为正]~%float32[2] sight_angle~%~%## 像素位置[相机系下：右方x为正，下方y为正]~%int32[2] pixel_position~%~%## 偏航角误差~%float32 yaw_error~%~%## 类别~%int32 category~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <DetectionInfo>))
  (cl:+ 0
     ...
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'pixel_position) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
     4
     4
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <DetectionInfo>))
  ...
  (cl:list 'DetectionInfo
    ...
    (cl:cons ':pixel_position (pixel_position msg))
