...
(cl:defclass <MultiDetectionInfo> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (num_objs
    ...
    :initform 0)
   (detect_or_track
    :reader detect_or_track
    :initarg :detect_or_track
    :type cl:integer
    :initform 0)
   (detection_infos
...
(cl:ensure-generic-function 'detect_or_track-val :lambda-list '(m))
(cl:defmethod detect_or_track-val ((m <MultiDetectionInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:detect_or_track-val is deprecated.  Use prometheus_msgs-msg:detect_or_track instead.")
  (detect_or_track m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MultiDetectionInfo>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'detect_or_track)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MultiDetectionInfo>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'detect_or_track) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MultiDetectionInfo>)))
  ...
  "405c23f2d6cf2075daf7e96c3ccd5179")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MultiDetectionInfo)))
  "Returns md5sum for a message object of type 'MultiDetectionInfo"
  "405c23f2d6cf2075daf7e96c3ccd5179")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MultiDetectionInfo>)))
  ...
  (cl:format cl:nil "Header header~%~%## 检测到的目标数量~%int32 num_objs~%~%## Detecting or Tracking (0:detect, 1:track)~%int32 detect_or_track~%~%## 每个目标的检测结果~%DetectionInfo[] detection_infos~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: prometheus_msgs/DetectionInfo~%std_msgs/Header header~%~%## 目标类别名称~%string object_name~%~%## 是否检测到目标~%bool detected~%~%## 0表示相机坐标系, 1表示机体坐标系, 2表示惯性坐标系~%int32 frame~%~%## 目标位置[相机系下：右方x为正，下方y为正，前方z为正]~%float32[3] position~%~%## 目标姿态-欧拉角-(z,y,x)~%float32[3] attitude~%~%## 目标姿态-四元数-(qx,qy,qz,qw)~%float32[4] attitude_q~%~%## 视线角度[相机系下：右方x角度为正，下方y角度为正]~%float32[2] sight_angle~%~%## 像素位置[相机系下：右方x为正，下方y为正]~%int32[2] pixel_position~%~%## 偏航角误差~%float32 yaw_error~%~%## 类别~%int32 category~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MultiDetectionInfo)))
  "Returns full string definition for message of type 'MultiDetectionInfo"
  (cl:format cl:nil "Header header~%~%## 检测到的目标数量~%int32 num_objs~%~%## Detecting or Tracking (0:detect, 1:track)~%int32 detect_or_track~%~%## 每个目标的检测结果~%DetectionInfo[] detection_infos~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: prometheus_msgs/DetectionInfo~%std_msgs/Header header~%~%## 目标类别名称~%string object_name~%~%## 是否检测到目标~%bool detected~%~%## 0表示相机坐标系, 1表示机体坐标系, 2表示惯性坐标系~%int32 frame~%~%## 目标位置[相机系下：右方x为正，下方y为正，前方z为正]~%float32[3] position~%~%## 目标姿态-欧拉角-(z,y,x)~%float32[3] attitude~%~%## 目标姿态-四元数-(qx,qy,qz,qw)~%float32[4] attitude_q~%~%## 视线角度[相机系下：右方x角度为正，下方y角度为正]~%float32[2] sight_angle~%~%## 像素位置[相机系下：右方x为正，下方y为正]~%int32[2] pixel_position~%~%## 偏航角误差~%float32 yaw_error~%~%## 类别~%int32 category~%~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MultiDetectionInfo>))
  ...
  (cl:list 'MultiDetectionInfo
    ...
    (cl:cons ':detect_or_track (detect_or_track msg))
