...
(cl:defmethod cl:initialize-instance :after ((m <StationCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StationCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name prometheus_msgs-msg:<StationCommand> is deprecated: use prometheus_msgs-msg:StationCommand instead.")))
...
(cl:defmethod flag-val ((m <StationCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:flag-val is deprecated.  Use prometheus_msgs-msg:flag instead.")
  (flag m))

(cl:ensure-generic-function 'first_goal-val :lambda-list '(m))
(cl:defmethod first_goal-val ((m <StationCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:first_goal-val is deprecated.  Use prometheus_msgs-msg:first_goal instead.")
  (first_goal m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <StationCommand>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'first_goal) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <StationCommand>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'first_goal) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StationCommand>)))
  ...
  "prometheus_msgs/StationCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StationCommand)))
  "Returns string type for a message object of type 'StationCommand"
  "prometheus_msgs/StationCommand")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<StationCommand>)))
  ...
  "a7052f956545dadb066c7cb9787c4c08")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'StationCommand)))
  "Returns md5sum for a message object of type 'StationCommand"
  "a7052f956545dadb066c7cb9787c4c08")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <StationCommand>))
  (cl:+ 0
     ...
     1
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'first_goal))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <StationCommand>))
  ...
  (cl:list 'StationCommand
    ...
    (cl:cons ':first_goal (first_goal msg))
