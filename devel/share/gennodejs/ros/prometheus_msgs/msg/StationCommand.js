...
class StationCommand {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('first_goal')) {
        this.first_goal = initObj.first_goal
      }
      else {
        this.first_goal = new geometry_msgs.msg.PoseStamped();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [first_goal]
    bufferOffset = geometry_msgs.msg.PoseStamped.serialize(obj.first_goal, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [first_goal]
    data.first_goal = geometry_msgs.msg.PoseStamped.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += geometry_msgs.msg.PoseStamped.getMessageSize(object.first_goal);
  ...
  static Resolve(msg) {
    ...
    if (msg.first_goal !== undefined) {
      resolved.first_goal = geometry_msgs.msg.PoseStamped.Resolve(msg.first_goal)
    }
    else {
      resolved.first_goal = new geometry_msgs.msg.PoseStamped()
    }
