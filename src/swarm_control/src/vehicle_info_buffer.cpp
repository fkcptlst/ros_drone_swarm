/*
 * @Author: lcf
 * @Date: 2022-01-31 21:47:05
 * @LastEditors: lcf
 * @LastEditTime: 2022-01-31 23:49:58
 * @FilePath: /swarm_ws2/src/swarm_control/src/vehicle_info_buffer.cpp
 * @Description: This node serve as an info buffer for each vehicle which buffers info from virtual_observer. Thus nodes name are uav1_vehicle_info_buffer etc
 * 
 */
